...
/***************************************************************************************                                               
* Description :   ADC start Conversion a chain of channels                                        
* Input  :  pointer of adc_chain struct
* Return:  None 
*****************************************************************************************/
...
/***************************************************************************************                                               
* Description :  start conversion with Async mode
* Input  :[ResolutionsOptions , address to return the data after conversion , ptr of function which will be excuted after interrupt]
* Return: error statues 
*****************************************************************************************/
